package edu.neu.hinf5300.concussionsidelineresponse.BalanceTest.painter;

import java.text.DecimalFormat;

import edu.neu.hinf5300.concussionsidelineresponse.BalanceTest.Level;
import edu.neu.hinf5300.concussionsidelineresponse.BalanceTest.config.DisplayType;
import edu.neu.hinf5300.concussionsidelineresponse.BalanceTest.config.Viscosity;
...
public class LevelPainter implements Runnable {
    ...
    public LevelPainter(SurfaceHolder surfaceHolder, Context context, 
    	...
    	//Lily this.lcdBackgroundPaint.getTextBounds(displayBackgroundText, 0, displayBackgroundText.length(), rect);
		...
		//Lily this.displayGap = context.getResources().getDimensionPixelSize(R.dimen.display_gap);
    	this.sensorGap = context.getResources().getDimensionPixelSize(R.dimen.sensor_gap);
		//Lily this.displayPadding = context.getResources().getDimensionPixelSize(R.dimen.display_padding);
		//Lily this.displayRect = new Rect();
